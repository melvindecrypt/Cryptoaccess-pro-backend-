...
exports.simulateInvestmentPayout = async (userId, planId, amountInvested) => {
...
exports.simulateWithdrawalProcessing = async (withdrawalId) => {
    try {
...
exports.applyAdminCredit = async (userId, currency, amount, reason) => {
    const session = await User.startSession();
    session.startTransaction();
...
exports.applyAdminDebit = async (userId, currency, amount, reason) => {
    const session = await User.startSession();
    session.startTransaction();
