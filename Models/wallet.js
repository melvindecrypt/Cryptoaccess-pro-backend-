...
walletSchema.methods = {
  async deposit(currency, amount, session = null) {
  ...
  async withdraw(currency, amount, session = null) {
  ...
  async updateBalance(currency, amount, type, session = null) {
