...
const investmentSchema = new Schema(
  {
    ...
    investmentType: {
      // e.g., "10000 Alpha+", "50000 Beta Elite"
      type: String,
      required: true, // Now required as it's generated by amount invested
    },
    duration: {
      // e.g., "3 months", "60 days", "1 year" (stored value from plan)
      type: String,
      required: true,
    },
    roi: {
      // e.g., 0.05 for 5% (stored value from plan)
      type: Number,
      required: true,
    },
    startDate: {
      // The exact date the investment started
      type: Date,
      default: Date.now,
      required: true,
    },
    endDate: {
      // The calculated end date of the investment
      type: Date,
      required: true,
    },
